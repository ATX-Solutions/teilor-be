...
export const findById = async (req: Request, res: Response) => {
    ...
    // return sendResponse({
    //     res,
    //     body: { statusCode: StatusCodes.OK, status: ReasonPhrases.OK, data, error: null },
    //     includeBodyOnSlack: false,
    // });
    ...
    try {
        ...
        // async "missed" on purpose. the email can be sendtafter the response is returned.
        sendProductEmail(data, req.params.id, req.query.email as string);
